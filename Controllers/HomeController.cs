...
public class HomeController(IEventService events) : Controller
{
    public async Task<IActionResult> Index(CancellationToken cancellationToken)
    {
        ...
        ViewData["MetaDescription"] =
            "Официальный сайт замка Вальдау (Вальдау) — средневековая крепость XIII века в пос. Низовье, Калининградская область. Посещение с аудиогидом, мероприятия, записаться онлайн.";
